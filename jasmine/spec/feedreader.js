    ...
    */
    ...
    describe('New Feed Selection', function() {
        ...
        it('loads new feed entries', function(done) {
            // new entries of the feed should be loaded -> save href of the first element
            var newLoadedFeedEntryHref = $('.feed > .entry-link').first().attr("href");
            // as a new feed was loaded, the first entry should have a different href than the previous one
            expect(initialFeedEntryHref).not.toBe(newLoadedFeedEntryHref);
            done();
        });
    });
}());
